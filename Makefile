...
SPRITES = sprites.c sprites_config.c load_sprites.c gun_render.c shoot.c aim.c bullets.c health_bar.c door_sprite_bonus.c
...
raycast_dda_algo_bonus.c door_validation_bonus.c sprites_helper.c door_interact_bonus.c
