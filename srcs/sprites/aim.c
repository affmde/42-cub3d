...
void	load_aim_texture(t_cub3d *cub3d)
{
	...
	cub3d->aim.img->img_ptr = mlx_xpm_file_to_image(cub3d->ptr, "textures/aim.xpm", &cub3d->aim.width, &cub3d->aim.height);
	if (!cub3d->aim.img->img_ptr)
		error_msg_exit("couldn't load the aim image");
	cub3d->aim.img->data = (int *)mlx_get_data_addr(cub3d->aim.img->img_ptr, &cub3d->aim.img->bpp, &cub3d->aim.img->size_l, 
